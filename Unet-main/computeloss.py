...
def generate_boundary(mask, dilation_ratio=0.02, sign=1):
...
def boundary_iou(gt, dt, dilation_ratio=0.02):
    dt_boundary = generate_boundary(dt, dilation_ratio, sign=1)
    gt_boundary = generate_boundary(gt, dilation_ratio, sign=0)
