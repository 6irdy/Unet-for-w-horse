...
需要将数据集按照指定位置放置，这一版本上传的是Unet训练版本，如需更换为NestedUNet，需要将main类中的UNet替换为NestedUNet
...
def train(model, data_loader, optimizer):
    ...
    print("training mean iou", mean_iou)
    print("training mean boundary_iou", mean_b_iou)
